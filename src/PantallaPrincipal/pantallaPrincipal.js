...
const PantallaPrincipal = () => {
    ...
    const toggleBusqueda = () => setmostratBusqueda(!mostratBusqueda);

    return (
        <div className="Pantalla-principal relative">
            {/* Fondo de video sin efectos */}
            <video
                autoPlay
                loop
                muted
            ...
            <header className="bg-black bg-opacity-90 shadow-lg relative z-10">
                <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <ul className="flex space-x-8 text-white text-lg font-light">
                        ...
                        <li>
                            <button onClick={toggleBusqueda} className="hover:text-gray-400 transition-all duration-300">
                                Buscar
                            </button>
                        </li>
