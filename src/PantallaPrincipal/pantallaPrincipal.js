                ...
                <nav className="container mx-auto px-6 py-4 flex justify-center">
                    <div className="text-center">
                        ...
                        <ul className="flex space-x-6 text-white font-light font-[Poppins] text-lg">
                            <li><Link to="/pantallaPrincipal" className="hover:text-gray-400 transition duration-300 no-underline">Inicio</Link></li>
                            ...
                            <li><Link to="/¿Cómo-usar?" className="hover:text-white-400 transition duration-300 no-underline">Cómo Usar</Link></li>
